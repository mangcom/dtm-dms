...
import { ROLE_LABEL, NAV_VISIBILITY } from "../lib/roles";
  ...
  return (
    <div className="animate-fadein">
      ...
      <div className="mb-6 text-sm text-text-2">
        บทบาท: {ROLE_LABEL[user.role]} · {user.department}
      </div>
